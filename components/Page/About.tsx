...
export class About extends React.Component<AboutProps, AboutState> {
  ...
  render() {
    return (
      <React.Fragment>
        <AboutWrap>
          <ImageReveal src="/profile-picture.png" delay={1000} />

          <TextReveal size="large" delay={1100}>
            "Voakie"
          </TextReveal>
          <TextReveal size="normal" delay={1200}>
            Christopher
          </TextReveal>
          <TextReveal size="normal" delay={1300}>
            contact@voakie.com
          </TextReveal>
          <TextReveal size="normal" delay={1400}>
            Made with{" "}
            <svg
              ...
              version="1.1"
            >
              <g id="Page-1" stroke="inherit" strokeWidth="1" fill="none" fillRule="evenodd">
                <g
                  id="Black-Next.js"
